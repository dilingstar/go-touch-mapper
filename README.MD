...
一般手机平板下载V2.0.0beta [go-touch-mapper](https://github.com/dilingstar/go-touch-mapper/releases/download/V2.0.0beta/go-touch-mapper)
...
```
pkg i golang yarn -y
git clone https://github.com/dilingstar/go-touch-mapper
cd go-touch-mapper
